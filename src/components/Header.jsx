export default function Header() {
  return (
    <header
      className="relative overflow-hidden border-b-4 px-4 md:px-8 pt-10 pb-8"
      style={{
    ...
    >
      ...
      <div className="max-w-[920px] mx-auto">
        <div className="text-[10px] tracking-[3px] uppercase font-bold mb-3"
          style={{ color: '#C1272D' }}>
        ...
        <div className="flex gap-4 mt-6 flex-wrap">
          {[
            ...
            >
              <div className="font-mono text-[22px] font-medium" style={{ color: '#C1272D' }}>{v}</div>
